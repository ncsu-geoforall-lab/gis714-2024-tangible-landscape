...
def simulate_fire_spotting(point_map, env, spotting_distance=100):
    ...
    """
    gs.run_command('v.buffer', input=point_map, output='fire_spotting_areas', distance=spotting_distance, env=env)
    gs.run_command('v.random', output='new_fire_spots', npoints=10, restrict='fire_spotting_areas', env=env)
